...
const SellerTechworld = () => {
  const [search, setSearch] = useState("");
  const [category, setCategory] = useState("All Categories");

  const products = [
    { id: 1, name: "Smart Laptop Pro", category: "Electronics", price: 1200, stock: 45, status: "In Stock" },
    { id: 2, name: "Wireless Headphones", category: "Electronics", price: 1200, stock: 45, status: "Low Stock" },
    { id: 3, name: "Tech Tablet Plus", category: "Electronics", price: 1200, stock: 45, status: "In Stock" },
    { id: 4, name: "Smart Laptop Pro", category: "Electronics", price: 1200, stock: 0, status: "Out of Stock" },
  ];
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white shadow-md rounded-2xl p-6 flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Techworld store</h2>
            ...
            <div className="flex items-center text-sm text-gray-500 mt-1 gap-3">
              <span className="flex items-center gap-1"><FiMail /> StayHard@techmaker.com</span>
...
export default SellerTechworld;
