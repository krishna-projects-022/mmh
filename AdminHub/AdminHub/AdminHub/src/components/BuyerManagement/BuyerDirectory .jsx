...
const BuyerDirectory = () => {
  ...
  // ✅ Filter buyers based on tab and search
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      {/* Title */}
      <h2 className="text-2xl font-bold mb-1">Buyer Management</h2>
      <p className="text-gray-500 mb-6">Buyer Directory</p>
    ...
    {["All", "Active", "Inactive", "Suspended"].map((tab) => (
      ...
      <div className="bg-white rounded-2xl shadow mb-6">
            ...
            <tbody>
              {filteredBuyers.map((buyer) => (
                <tr key={buyer.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="p-4">{buyer.registration}</td>
                  <td className="p-4">{buyer.lastActive}</td>
        ...
        <div className="flex justify-between items-center p-4 text-gray-600 text-sm">
          <p>Showing 1 to {filteredBuyers.length} of 127 buyers</p>
